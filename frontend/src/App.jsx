...
// Clé CSS sûre pour les noms de type (accents/slashes → ASCII)
const TYPE_CSS_KEY = {
  "général":  "general",
  "ci/cd":    "cicd",
  "sécurité": "securite",
...
function App() {
  ...
  // Chargement initial des projets et tâches
  useEffect(() => {
  ...
  // Filtrage local par projet sélectionné
    ...
    <div className="app">
      ...
      <header className="app-header">
        <div className="app-header__top">
          <div className="app-header__brand">
            ...
            <div>
              {/* Le texte exact est conservé pour les tests */}
      ...
      <main className="app-main">
        ...
        <section className="card">
          {/* Texte exact requis par les tests frontend */}
          <h2 className="section-heading">Ajouter une nouvelle tâche</h2>

          <form onSubmit={handleSubmit} className="task-form">
            {/* Ligne principale : titre + projet */}
            ...
            {/* Ligne méta : type, priorité, statut + bouton */}
